...
public class MaboutusAction extends ActionSupport {
    ...
    public String execute() throws Exception {
        Aboutus aboutus = aboutusRepository.findOneByName("aboutus1");
        if (aboutus != null) {
            aboutus1content = aboutus.getContent();
        }

        aboutus = aboutusRepository.findOneByName("aboutus2");
        if (aboutus != null) {
            aboutus2content = aboutus.getContent();
        }

        aboutus = aboutusRepository.findOneByName("aboutus3");
        if (aboutus != null) {
            aboutus3content = aboutus.getContent();
        }

        aboutus = aboutusRepository.findOneByName("aboutus4");
        if (aboutus != null) {
            aboutus4content = aboutus.getContent();
        }

        aboutus = aboutusRepository.findOneByName("aboutus5");
        if (aboutus != null) {
            aboutus5content = aboutus.getContent();
        }

        aboutus = aboutusRepository.findOneByName("aboutusmenu");
        if (aboutus != null) {
