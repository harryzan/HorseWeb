...
<div class="Header_ourhorse"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="500"><table width="500" border="0">
      <tr>
          <td align="right"><a href="${ctx}/cnmanage/mhorse" style="cursor: pointer"><img src="${themesPath}/images/zg_logo.png" width="36" height="27" /></a><a href="${ctx}/manage/mhorse" style="cursor:pointer"><img src="${themesPath}/images/yg_logo.png" width="36" height="27" /></a>&nbsp;&nbsp;</td>
      </tr>
      <tr>
        <td height="125"><table width="485" border="0" align="right">
          <tr>
            <td width="89"><a href="mindex" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image64','','${themesPath}/images/home_1.png',1)"><img src="${themesPath}/images/home.png" name="Image64" width="89" height="37" border="0" id="Image64" /></a></td>
            ...
            <td width="93"><a href="mhorse"><img src="${themesPath}/images/ourhorses_1.png" width="89" height="37" /></a></td>
  ...
  <tr>
    <td height="61" colspan="2" background="${themesPath}/images/horse_1.jpg"><table width="960" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center"><a href ="mhorse"><img src="${themesPath}/images/ourhorse_2.png" width="111" height="35" /></a></td>
        <td align="center"><img src="${themesPath}/images/ourhorse_line.jpg" width="3" height="35" /></td>
        <td align="center"><a href="mhorse?type=dressage" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','${themesPath}/images/ourhorse_4.png',1)">
        ...
        <td align="center"><a href="mhorse?type=jumping" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','${themesPath}/images/ourhorse_6.png',1)">
            <img src="${themesPath}/images/ourhorse_5.png" name="Image15" width="182" height="35" border="0" id="Image15" /></a></td>
        <td align="center"><img src="${themesPath}/images/ourhorse_line.jpg" alt="" width="3" height="35" /></td>
        <td align="center"><a href="mhorse?type=family" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','${themesPath}/images/ourhorse_8.png',1)">
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><table width="960" border="0" cellpadding="0" cellspacing="0">
            ...
            <td bgcolor="#FFFFFF"><table width="960" border="0" cellpadding="0" cellspacing="0">
                ...
                <c:forEach items="${horses}" var="horse" varStatus="status">
                    <c:if test="${(status.count - 1)%3 == 0}">
                        ...
                        <td width="320">
                            <div style="width:297px; height:432px;position: relative;">
                                <div style="position:absolute;left:0;top:0;z-index:2;">
                                <input onclick="upEditor('${horse.name}', '${editorname}','${type}');location.reload();" type="button" class="tab_moveup">
                                <input onclick="downEditor('${horse.name}', '${editorname}'),'${type}';location.reload();" type="button" class="tab_movedown">
                                <input onclick="createEditor('${horse.name}', '${editorname}');" type="button" class="tab_xiugai">
                                <input onclick="saveEditor('${horse.name}', ${horse.order}, 'Horse');" type="button" class="tab_save">
                                <input onclick="removeEditor('${horse.name}', ${horse.order}, 'Horse');location.reload();" type="button" class="tab_del">
                                </div>
                                <div id="${horse.name}" style="display: '';position:absolute;left:0;top:0;z-index:1;">
                                        ${horse.content}
                                </div>
                            </div>
                        </td>
        ...
        <tr>
            <td>
                <div style="width:297px; height:432px">
                    <input onclick="createEditor('horse${count+1}', 'editor');" type="button" class="tab_add">
                    <input onclick="saveEditor('horse${count+1}', ${count+1}, 'Horse', '${type}');location.reload();" type="button" class="tab_save">
                    <div id="horse${count+1}" style="display: '';">
                    </div>
                </div>
            </td>
        </tr>
    ...
    <div class="Foot">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td height="249" background="${themesPath}/images/foot_bg.jpg"><table width="960" border="0">
                    <tr>
                        <td colspan="3">
