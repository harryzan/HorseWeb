        ...
        <table width="700" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td height="500" valign="top" bgcolor="#ffffff"><table width="680" border="0" align="center">
                    ...
                    <tr>
                        <td width="676">
                            <div style="width:679px; height:800px; position:relative;">
                                <div style="position:absolute;left:0;top:0;z-index:2;">
                                    <input onclick="createEditor('aboutus1', 'editor1');" type="button" class="tab_xiugai">
                                    <input onclick="saveEditor('aboutus1', 1, 'Aboutus');" type="button" class="tab_save">
                                </div>
                    ...
                    <tr>
                        <td width="676">
                            <div style="width:679px; height:800px; position:relative;">
                                <div style="position:absolute;left:0;top:0;z-index:2;">
                                    <input onclick="createEditor('aboutus2', 'editor2');" type="button" class="tab_xiugai">
                                    <input onclick="saveEditor('aboutus2', 2, 'Aboutus');" type="button" class="tab_save">
                                </div>
                    ...
                    <tr>
                        <td width="676">
                            <div style="width:679px; height:1000px; position:relative;">
                                <div style="position:absolute;left:0;top:0;z-index:2;">
                                    <input onclick="createEditor('aboutus3', 'editor3');" type="button" class="tab_xiugai">
                                    <input onclick="saveEditor('aboutus3', 3, 'Aboutus');" type="button" class="tab_save">
                                </div>
                                <div id="aboutus3" style="display: '';position:absolute;left:0;top:0;z-index:1;">
                                    ${aboutus3content}
                                </div>
                            </div>
                        </td>
          ...
          <td rowspan="2" align="right" class="foot_text">
              <div style="width:484px; height:139px; position:relative;">
                  <div style="position:absolute;right:0;top:0;z-index:2;">
                      <input onclick="createEditor('introduction', 'editor6');" type="button" class="tab_xiugai">
