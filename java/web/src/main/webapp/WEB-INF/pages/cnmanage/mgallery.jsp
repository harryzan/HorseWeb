...
<div class="Header"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="455"><table width="500" border="0">
      <tr>
          <td align="right"><a href="${ctx}/cnmanage/mgallery" style="cursor: pointer"><img src="${themesPath}/images/zg_logo.png" width="36" height="27" /></a><a href="${ctx}/manage/mgallery" style="cursor:pointer"><img src="${themesPath}/images/yg_logo.png" width="36" height="27" /></a>&nbsp;&nbsp;</td>
      </tr>
      <tr>
            ...
            <td width="700" valign="top"><table width="700" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        ...
                        <input onclick="createEditor('gallery${count+1}', 'editor');" type="button" class="tab_add">
                        <input onclick="saveEditor('gallery${count+1}', ${count+1}, 'Gallery');location.reload();" type="button" class="tab_save">
                        <div id="gallery${count+1}" style="display: '';">
                        </div>
                    </td>
                </tr>
            </table>
                <table width="700" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td valign="top"><table width="698" border="0" cellpadding="0" cellspacing="0">
                            <tr>
            ...
            <td width="260" valign="top"><table width="230" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td valign="top" background="${themesPath}/images/left_2.jpg">
                        <table width="200" border="0" align="center" style="vertical-align: top">
                            <c:forEach items="${galleries}" var="gallery" varStatus="status">
                                ...
                                <td height="70">
                                    ...
                                    <div style="z-index: 2;position:absolute;left:0;top:0">
                                        <input onclick="createEditor('${gallery.name}', 'editor');" type="button" class="tab_xiugai">
                                        <input onclick="saveEditor('${gallery.name}', ${gallery.order}, 'Gallery');" type="button" class="tab_save">
                                        <input onclick="removeEditor('${gallery.name}', ${gallery.order}, 'Gallery');location.reload();" type="button" class="tab_del">
                                    </div>
                                    <div id="${gallery.name}" onclick="enlarge(this);" style="position:absolute;left:0;top:0;z-index:1;cursor:pointer; width:85px; height:54px;display: '';">
                                        ${gallery.content}
                                    </div>
                                    </div>
                                </td>
