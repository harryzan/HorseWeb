...
<div class="Header"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="455"><table width="500" border="0">
      <tr>
          <td align="right"><a href="${ctx}/cnmanage/mintro" style="cursor: pointer"><img src="${themesPath}/images/zg_logo.png" width="36" height="27" /></a><a href="${ctx}/manage/mintro" style="cursor:pointer"><img src="${themesPath}/images/yg_logo.png" width="36" height="27" /></a>&nbsp;&nbsp;</td>
      </tr>
      <tr>
        ...
        <td><table width="700" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="500" valign="top" bgcolor="#ffffff"><table width="680" border="0">
                ...
                <tr>
                    <td width="676">
                        <div style="width:679px; height:388px; position:relative;">
                            <div style="position:absolute;left:0;top:0;z-index:2;">
                                <input onclick="createEditor('${name}', 'editor1');" type="button" class="tab_xiugai">
                                <input onclick="saveEditor('${name}', 1, 'Introduction');" type="button" class="tab_save">
                            </div>
                            <div id="${name}" style="display: '';position:absolute;left:0;top:0;z-index:1;">
                                ${content}
                            </div>
                        </div>
                    </td>
