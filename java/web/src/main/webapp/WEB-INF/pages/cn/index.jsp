...
<div class="Header_bg_1"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td width="455"><table width="500" border="0">
            <tr>
                <td align="right"><a href="${ctx}/cn/index" style="cursor: pointer"><img src="${themesPath}/images/zg_logo.png" width="36" height="27" /></a><a href="${ctx}/index" style="cursor:pointer"><img src="${themesPath}/images/yg_logo.png" width="36" height="27" /></a>&nbsp;&nbsp;</td>
            </tr>
            <tr>
                    ...
                    <%--<td colspan="3">--%>
                        <%--<div style="position: relative;">--%>
                            <%--<div style="position:absolute;left:0;top:0;z-index:2;">--%>
                                ...
                                <%--<input onclick="saveEditor('pic', 1, 'Home');" type="button" class="tab_del">--%>
                            <%--</div>--%>
                ...
                <tr>
                    <td>
                        <table width="960" border="0" align="center">
                            ...
                            <tr>
                                <td height="39" colspan="3" align="center" style="vertical-align: top">
                                            ${highlightcontent}
                                </td>
                            </tr>
                        </table>
