...
<div class="Header"><table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="455"><table width="500" border="0">
      <tr>
          <td align="right"><a href="${ctx}/cn/contact" style="cursor: pointer"><img src="${themesPath}/images/zg_logo.png" width="36" height="27" /></a><a href="${ctx}/contact" style="cursor:pointer"><img src="${themesPath}/images/yg_logo.png" width="36" height="27" /></a>&nbsp;&nbsp;</td>
      </tr>
      <tr>
        <td height="200"><table width="485" border="0" align="right">
          <tr>
            ...
            <td width="89" align="right"><a href="contact"><img src="${themesPath}/images/contact_1.png" width="89" height="37" /></a></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
